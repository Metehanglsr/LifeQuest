...
public sealed class AppRoleReadRepository : ReadRepository<AppRole>, IAppRoleReadRepository
{
    public AppRoleReadRepository(LifeQuestDbContext context) : base(context)
    {
    }
}